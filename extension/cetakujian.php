...
<body>
    ...
    <p>Disahkan tanggal 29 Juni 2020 dan telah diperiksa oleh Sekretaris Jurusan Teknologi Informasi. Atas perhatian Bapak/Ibu Dosen Kami sampaikan terima kasih.</p>
<p><br><b>Catatan:</b></p>
...
<footer>
    <script>document.title="<?php echo 'Jadwal Ujian TA-'.$nama_dosen; ?>";window.print();</script>
</footer>
