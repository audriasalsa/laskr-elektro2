...
<body>
    ...
    $nama_dosen = '';
    if($dosenrow = @mysql_fetch_assoc($dosencols)){
    ...
    <table>
        ...
        while ( $queryrow = @mysql_fetch_assoc($querycols) ) {
    ...
    <p>Disahkan tanggal 27 Februari 2020 dan telah diperiksa oleh Sekretaris Jurusan Teknologi Informasi. Atas perhatian Bapak/Ibu Dosen Kami sampaikan terima kasih. <a href="cetak.php?id=<?=$ID?>&k=<?=$key?>" target="_blank">Cetak Ke PDF</a></p>
