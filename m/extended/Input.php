...
PHP_HEREDOC;
    ...
    public static function createActionButton($id, $value, $onClickAction)
    {
        // <input type="button" value="Click me" onclick="msg()">
        $button = new Input($id, 'button');
        $button->setValue($value);
        $button->addAdditionalAttribute('onclick', $onClickAction);
